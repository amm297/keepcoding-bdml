...
LOAD DATA INPATH 'input/el-tenedor.csv' INTO TABLE restaurants;
LOAD DATA INPATH 'input/public-transport.json' INTO TABLE public_transport;
LOAD DATA INPATH 'input/airbnb-listings.csv' INTO TABLE airbnb;
